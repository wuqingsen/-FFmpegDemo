...
Java_com_wuqingsen_bigeye_OpencvJni_init(JNIEnv *env, jobject thiz, jstring path_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wuqingsen_bigeye_OpencvJni_postData(JNIEnv *env, jobject instance, jbyteArray data_,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wuqingsen_bigeye_OpencvJni_setSurface(JNIEnv *env, jobject instance, jobject surface) {
